registerTheme({
  async mount(context) {
    ...
    context.renderTemplateV1({
        stageClass: "hy3-stage",
        hero: { tag: "section", className: "hy3-hero-copy", html: `<span class="hy3-kicker" data-theme-part="hero-kicker"><i></i><span class="hy3-light-only">PRESENT SELF · SNOWBOUND VOW</span><span class="hy3-dark-only">FORECLAIMED · BLADE LIBERATION</span></span>
        ...
        taskSecondary: { tag: "aside", className: "hy3-task-card hy3-task-right hy3-task-present", html: `<i data-theme-part="task-card-art"></i><div data-theme-part="task-card-caption"><b>常世 · 居合</b><small>PRESENT SELF / 02</small></div>` },
        taskPrimary: { tag: "aside", className: "hy3-task-card hy3-task-right hy3-task-foreclaimed", html: `<i data-theme-part="task-card-art"></i><div data-theme-part="task-card-caption"><b>预求 · 归刃</b><small>FORECLAIMED / 03</small></div>` },
        memory: { tag: "aside", className: "hy3-memory", html: `<small>SPECIAL RESPONSE · 愿望档案</small><p>${config.memory}</p><span class="hy3-memory-sigil" data-theme-part="memory-meter" aria-hidden="true"><svg viewBox="0 0 122 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path class="hy3-memory-vow" d="M8 20c10-15 23-15 32-3 8 11 18 11 27-2 10-15 24-13 32 1 6 10 12 10 18 2"/><path class="hy3-memory-orbit" d="M46 16c4-8 10-12 15-12s11 4 15 12c-4 8-10 12-15 12s-11-4-15-12Z"/><path class="hy3-memory-frost" d="m61 7 2.7 6.3L70 16l-6.3 2.7L61 25l-2.7-6.3L52 16l6.3-2.7L61 7Z"/><path class="hy3-memory-echo" d="M22 26h18M82 26h18"/></svg></span>` },
        syncPanel: { tag: "div", className: "hy3-syntax hy3-foreclaim-array", html: `<span class="hy3-syntax-copy" data-theme-part="sync-copy"><small>预求我身 · 万世霜天</small><b>寒意 <strong>III</strong><em>/III</em></b></span>
        ...
        composerAccessory: { tag: "div", className: "hy3-weapon-charm", html: `<svg class="hy3-frostburn" viewBox="0 0 100 100" aria-hidden="true">
          <defs>
