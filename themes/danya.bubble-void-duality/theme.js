registerTheme({
  async mount(context) {
    ...
    context.renderTemplateV1({
        ...
        stageDecorations: `<div class="dny-hero-fx dny-hero-fx-light dny-light-only" aria-hidden="true"><span class="dny-stage-orbit"><i></i><i></i><b></b></span><span class="dny-pearl-constellation"><i></i><i></i><i></i><i></i></span><span class="dny-curtain-wave"><i></i><i></i><i></i></span></div>
...
<div class="dny-bubbles">${Array.from({length:14},(_,i)=>`<i style="--i:${i}"></i>`).join("")}</div>`,
        ...
        syncPanel: { tag: "div", className: "dny-sync", html: `<span data-theme-part="sync-copy"><small>FORM SYNCHRONIZATION</small><b class="dny-light-only">伪装稳定 · 97.4%</b><b class="dny-dark-only">侵蚀稳定 · 99.8%</b></span><div data-theme-part="sync-meter">${Array.from({length:15},()=>"<i></i>").join("")}</div><i class="dny-sync-contract-part" data-theme-part="sync-core"></i><i class="dny-sync-contract-part" data-theme-part="sync-state"></i>` },
