    ...
    root.innerHTML = `
      <div class="dny-stage" data-theme-stage>
        <section class="dny-hero-copy" data-theme-role="hero" data-theme-part="hero-copy">
          <span class="dny-kicker" data-theme-part="hero-kicker"><i></i><span class="dny-light-only">HUMAN ANNOTATION · 泡影记录</span><span class="dny-dark-only">VOID ANNOTATION · 幻灭记录</span></span>
          ...
          <p>${config.subtitle}</p>
          <div class="dny-domain-line" data-theme-part="hero-motion"><span></span><i></i><b></b><i></i><span></span></div>
        ...
        <div class="dny-identity" data-theme-role="identity" data-theme-part="identity"><span class="dny-avatar" data-theme-part="identity-emblem"></span><span data-theme-part="identity-copy"><b>${config.title}</b><small class="dny-light-only">${config.status}</small><small class="dny-dark-only">VOID FORM · ANNIHILATION SYNC</small></span><i data-theme-part="identity-status"></i></div>
        <aside class="dny-portrait-card" data-theme-role="task-left" data-theme-part="task-card-left"><div class="dny-portrait-art" data-theme-part="task-card-art"></div><div data-theme-part="task-card-caption"><b class="dny-light-only">达妮娅 · 泡影</b><b class="dny-dark-only">达妮娅 · 虚阈</b><small class="dny-light-only">HUMAN DISGUISE / 01</small><small class="dny-dark-only">TRUE VOID FORM / 01</small></div></aside>
        <aside class="dny-observer" data-theme-role="task-right" data-theme-priority="primary" data-theme-part="task-card-right-primary"><div class="dny-observer-art" data-theme-part="task-card-art"></div><div data-theme-part="task-card-caption"><b class="dny-light-only">达妮娅 · 伪装</b><b class="dny-dark-only">达妮娅 · 真形</b><small class="dny-light-only">BUBBLE DOMAIN ACTIVE</small><small class="dny-dark-only">SILENCE DOMAIN ACTIVE</small></div></aside>
        <aside class="dny-alt-card" data-theme-role="task-right" data-theme-priority="secondary" data-theme-part="task-card-right-secondary"><div class="dny-alt-art" data-theme-part="task-card-art"></div><div data-theme-part="task-card-caption"><b class="dny-light-only">伪装 · 观星</b><b class="dny-dark-only">真形 · 湮灭</b><small class="dny-light-only">BUBBLE THEATRE / 02</small><small class="dny-dark-only">ANNIHILATION FIELD / 02</small></div></aside>
        <aside class="dny-memory" data-theme-role="memory" data-theme-part="memory-card"><small class="dny-light-only">HUMAN MEMORY</small><small class="dny-dark-only">VOID MEMORY</small><p class="dny-light-only">${config.memory}</p><p class="dny-dark-only">所有被观测的星光，终将在寂静虚阈中熄灭。</p><span class="dny-memory-sigil" data-theme-part="memory-meter"><svg viewBox="0 0 122 32" aria-hidden="true"><defs><radialGradient id="dny-memory-bubble"><stop offset="0" stop-color="#fff" stop-opacity=".82"/><stop offset=".48" stop-color="#f8c7e4" stop-opacity=".36"/><stop offset=".76" stop-color="#8de8f3" stop-opacity=".2"/><stop offset="1" stop-color="#8a7ce2" stop-opacity=".08"/></radialGradient><radialGradient id="dny-memory-void"><stop offset="0" stop-color="#050817"/><stop offset=".48" stop-color="#151142"/><stop offset=".78" stop-color="#6a32c5"/><stop offset="1" stop-color="#b256e7" stop-opacity=".25"/></radialGradient><linearGradient id="dny-memory-orbit" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#f5c570"/><stop offset=".42" stop-color="#ffb8db"/><stop offset=".72" stop-color="#86e6ee"/><stop offset="1" stop-color="#8273dd"/></linearGradient></defs><path class="dny-memory-trace dny-memory-trace-left" d="M2 18h23l7-5h12"/><path class="dny-memory-trace dny-memory-trace-right" d="M120 18H97l-7-5H78"/><g class="dny-memory-orbits"><ellipse cx="61" cy="16" rx="24" ry="9"/><ellipse cx="61" cy="16" rx="11" ry="23" transform="rotate(58 61 16)"/></g><circle class="dny-memory-bubble" cx="61" cy="16" r="12"/><circle class="dny-memory-core" cx="61" cy="16" r="7"/><path class="dny-memory-star" d="M61 5l2.5 7.3L71 16l-7.5 3.7L61 27l-2.5-7.3L51 16l7.5-3.7Z"/><path class="dny-memory-constellation" d="M56 19l3-7 5 3 3-4M59 12l-4-3M64 15l4 4"/><g class="dny-memory-satellites"><circle cx="38" cy="9" r="2.2"/><circle cx="82" cy="24" r="1.8"/><circle cx="88" cy="8" r="1.3"/></g></svg></span></aside>
        <div class="dny-sync" data-theme-role="sync-panel" data-theme-priority="secondary" data-theme-part="sync-panel"><span data-theme-part="sync-copy"><small>FORM SYNCHRONIZATION</small><b class="dny-light-only">伪装稳定 · 97.4%</b><b class="dny-dark-only">侵蚀稳定 · 99.8%</b></span><div data-theme-part="sync-meter">${Array.from({length:15},()=>"<i></i>").join("")}</div><i class="dny-sync-contract-part" data-theme-part="sync-core"></i><i class="dny-sync-contract-part" data-theme-part="sync-state"></i></div>
        <div class="dny-weapon-charm" data-theme-role="composer-accessory" data-theme-part="composer-accessory">
