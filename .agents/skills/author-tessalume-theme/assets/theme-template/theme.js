  ...
  async mount(context) {
    ...
    context.renderTemplateV1({
        ...
        hero: { tag: "section", className: "__NS__-hero-copy", html: `<span class="__NS__-hero-kicker" data-theme-part="hero-kicker">
          ...
          <p>${config.subtitle}</p>
          <div class="__NS__-hero-motion" data-theme-part="hero-motion" data-theme-draft="replace-home-motion" aria-label="${config.motionLabel}">
        ...
        <span class="__NS__-sync-core" data-theme-part="sync-core" data-theme-draft="replace-sync-instrument"><i></i><b>${config.syncCore}</b><small>${config.syncCoreLabel}</small></span>
        ...
        composerAccessory: { tag: "div", className: "__NS__-composer-accessory", html: `<i data-theme-draft="replace-character-accessory"></i><b>${config.accessorySymbol}</b><small>${config.accessoryLabel}</small>` },
      });
