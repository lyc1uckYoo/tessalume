...
internal static class CompatibilityHealthService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var recordedPackVersion = state?.CompatibilityPackVersionAtLastApply;
        return new CompatibilityHealthSnapshot(
            installedVersion,
            ThemeRuntime.ContractVersion,
            compatibilityPack.PackVersionLabel,
            compatibilityPack.IsBuiltIn,
            ...
            !string.IsNullOrWhiteSpace(recordedPackVersion) &&
                !string.Equals(
                    recordedPackVersion.TrimStart('v', 'V'),
                    compatibilityPack.PackVersion.ToString(),
